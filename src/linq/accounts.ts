...
function resolveToken(
  ...
  const refToken =
    resolveSecretRef(secretRefFromValue(merged.apiToken)) ?? resolveSecretRef(merged.apiTokenRef);
  if (refToken) {
...
function resolveWebhookSecret(
  ...
  const refSecret =
    resolveSecretRef(secretRefFromValue(merged.webhookSecret)) ??
    resolveSecretRef(merged.webhookSecretRef);
  if (refSecret) {
