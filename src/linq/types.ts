...
export type LinqAccountConfig = {
  ...
  /** Alternate SecretRef-backed Linq API token field. */
  apiTokenRef?: LinqSecretRef;
  ...
  /** Alternate SecretRef-backed webhook HMAC signing secret field. */
  webhookSecretRef?: LinqSecretRef;
